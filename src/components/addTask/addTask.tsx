...
const AddTask:React.FC<any> = () => {
    ...
    const { addTask } : any = useTodo()
    const { closeModal } = useUI()
    const [filters, setFilters] = React.useState<ITask | any>({})
    ...
    return (
        ...
        >
            ...
            >
                <Button variant='outlined' style={{background:"#2ab4aa",width:"110px"}} color='primary' onClick={addTodo} > save </Button>
